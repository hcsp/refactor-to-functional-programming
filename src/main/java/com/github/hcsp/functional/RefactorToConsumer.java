...
public class RefactorToConsumer {
    ...
    public static BiConsumer<String, String> joinKeyAndValueByDelimiter(String delimiter) {
        return (a, b) -> System.out.println(String.join(delimiter, a, b));
    }

    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, joinKeyAndValueByDelimiter(","));
    }
