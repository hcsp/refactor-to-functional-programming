...
public class RefactorToConsumer {
    ...
    public static BiConsumer<String, String> buildBiConsumer(String splitter) {
        return (s1, s2) -> System.out.println(s1 + splitter + s2);
    }
    ...
    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, buildBiConsumer(","));
    }
