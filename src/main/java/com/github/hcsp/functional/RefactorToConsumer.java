...
public class RefactorToConsumer {
    ...
    public static void printWithConsumer(
        ...
        BiConsumer<Map<String, String>, Map<String, String>> biConsumer = getBiConsumer(consumer);
        biConsumer.accept(map1, map2);
    }

    private static BiConsumer<Map<String, String>, Map<String, String>> getBiConsumer(BiConsumer<String, String> consumer) {
        return (map1, map2) -> {
