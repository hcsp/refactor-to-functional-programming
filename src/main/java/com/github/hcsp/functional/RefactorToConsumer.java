...
public class RefactorToConsumer {
    ...
    private static BiConsumer<Map<String, String>, Map<String, String>> mapBiConsumer(BiConsumer<String, String> consumer) {
        return (lhs, rhs) -> {
            lhs.forEach(consumer::accept);
            rhs.forEach(consumer::accept);
        };
    }
    ...
    public static void printWithConsumer(
        ...
        mapBiConsumer(consumer).accept(map1, map2);
    }

    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        BiConsumer<String, String> consumer = (lhs, rhs) -> {
