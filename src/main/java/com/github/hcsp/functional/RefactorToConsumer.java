...
public class RefactorToConsumer {
    ...
    public static BiConsumer<String, String> connectKeyValue(String symbol) {
        return (s1, s2) -> System.out.println(s1 + symbol + s2);
    }
    ...
    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, connectKeyValue(","));
    }
