...
public class RefactorToConsumer {
    ...
    private static BiConsumer<String, String> separateWith(String separator) {
        return (key, val) -> System.out.println(key + separator +  val);
    }

    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, separateWith(","));
    }
