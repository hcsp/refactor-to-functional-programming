...
public class RefactorToConsumer {
    ...
    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, (s, s2) -> print(map1, map2, ","));
    }
    ...
    public static void print(Map<String, String> map1, Map<String, String> map2, String joiner) {
        for (Map.Entry<String, String> entry : map1.entrySet()) {
            String key = entry.getKey();
            String value = entry.getValue();
            System.out.println(key + joiner + value);
        }
