...
public class RefactorToConsumer {
    ...
    public static BiConsumer<String, String> createBiConsumerWith(String symbol) {
        return (key, value) -> System.out.println(key + symbol + value);
    }

    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, createBiConsumerWith(","));
    }
