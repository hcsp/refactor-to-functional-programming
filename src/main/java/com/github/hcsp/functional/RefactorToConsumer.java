...
public class RefactorToConsumer {
    ...
    public static BiConsumer<String, String> reBiConsumer(String split) {
        return (str1, str2) -> System.out.println(str1 + split + str2);
    }

    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, reBiConsumer(","));
    }
