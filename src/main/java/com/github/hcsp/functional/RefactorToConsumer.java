...
public class RefactorToConsumer {
    ...
    public static void specifyPrintSymbol(Map<String, String> map1, Map<String, String> map2, String symbol) {
        printWithConsumer(map1, map2, (key, value) -> System.out.println(key + symbol + value));
    }
}
