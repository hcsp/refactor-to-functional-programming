...
public class RefactorToConsumer {
    ...
    private static void specifyPrintSymbol(Map<String, String> map1, Map<String, String> map2, String symbol) {
        printWithConsumer(map1, map2, (k, v) -> System.out.println(k + symbol + v));
    }
