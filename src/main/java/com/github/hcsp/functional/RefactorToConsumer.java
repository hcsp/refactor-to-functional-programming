...
public class RefactorToConsumer {
    ...
    public static void printWithComma(Map<String, String> map1, Map<String, String> map2) {
        printWithConsumer(map1, map2, getStringStringBiConsumer(","));
    }
    ...
    private static BiConsumer<String, String> getStringStringBiConsumer(String s) {
        return (k, v) -> System.out.println(k + s + v);
    }
}
