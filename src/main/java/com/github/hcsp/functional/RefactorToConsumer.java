...
public class RefactorToConsumer {
    ...
    public static void printWithConsumer(Map<String, String> map1, Map<String, String> map2, BiConsumer<String, String> consumer) {
        map1.forEach(consumer);
        map2.forEach(consumer);
    }

    public static BiConsumer<Map<String, String>, Map<String, String>> printWithPrefix(String prefix) {
        return (Map<String, String> map1, Map<String, String> map2) -> printWithConsumer(map1, map2, (key, val) -> System.out.println(key + prefix + val));
    }
