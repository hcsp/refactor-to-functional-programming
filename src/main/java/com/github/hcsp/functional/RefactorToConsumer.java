...
public class RefactorToConsumer {
    ...
    public static BiConsumer<Map<String, String>, Map<String, String>> wrapperBiConsumer(BiConsumer<String, String> consumer) {
        return (map1, map2) -> {
    ...
    public static void printWithConsumer(Map<String, String> map1, Map<String, String> map2, BiConsumer<String, String> consumer) {
        wrapperBiConsumer(consumer).accept(map1, map2);
    }
