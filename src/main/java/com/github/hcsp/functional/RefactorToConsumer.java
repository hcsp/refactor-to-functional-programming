...
public class RefactorToConsumer {
    ...
    private static void stringSequence(Map<String, String> map1, Map<String, String> map2, String s) {
        printWithConsumer(map1, map2, (key, value) -> System.out.println(key + s + value));
    }
}
